const quiz = [
    ...
    {
        q: "It's fine to litter on the street because someone will collect it eventually.",
        options: ["True", "False"],
        answer: 1,
    ...
    {
        q: "Protecting the water streams is an adult task because I cannot do anything about it.",
        options: ["True", "False"],
        answer: 1,
        explain: "You can always do small things to protect our water streams everyday! Just rememeber to put the trash to the pin, recycle or reuse the plastics whenever you can, and advoid flushing not flushable items down the toilets."
    },
    {
        q: "Reusing water after you take a bath, washing dishes or clothes for other purposes is a way to save water.",
        options: ["True", "False"],
        answer: 0,
        explain: "This is a way that can help you save water. The water, in this case, is called greywater. You can collect the water by using buckets or containers. Make sure you would use it within 24 hours."
    ...
    {
        q: "How many percentages of water in the world is fresh?",
        options: ["50%", "10%", "100%", "2.5%"],
        answer: 3,
        explain: "Although water covers 70%, unfortunately, only 2.5% of it is freshwater. Try to save water as much as you can since our water source is limited!"
    ...
    {
        q: "Which year are we going to run out of water?",
    ...
    {
        q: "Bring your own bottle can help reduce plastic wastes on water catchment.",
        options: ["True", "False"],
        answer: 0,
        explain: "Since plastics are harmful to our environment, bringing your own bottle whenever you go out can help us reduce plastic usage, hence protect the water catchment."
    },
    {
        ...
        answer: 0,
        explain: "Dripping tap can waste a huge amount of water. Pay attention whenever you see dripping taps!"
    }
]